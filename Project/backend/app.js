...
var path        = Bootstrap.path;
var favicon     = Bootstrap.favicon;
var logger      = Bootstrap.logger;
var cookieParser = Bootstrap.cookie;
var bodyParser  = Bootstrap.bodyParser;
var session     = Bootstrap.session;
var redisSess   = Bootstrap.redis(session);

var mongoConnection = Bootstrap.mongoConnection;
...
// app.set('layout', 'layout/main.js');
app.use(Bootstrap.ejsLayout);
